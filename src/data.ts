...
export const THE_6_CS: SectorDetail[] = [
  ...
  },
  {
    id: 'c3',
    title: 'Calor',
    titleEn: 'Calor (Radiant Solar Heat)',
    subtitle: 'Energia Solar, Alta Insolação & Transição Energética',
    subtitleEn: 'Solar Energy, High Irradiance & Clean Power Transition',
    description: 'O clima quente e a elevada insolação que caracterizam a província de Tete. Com índices de radiação solar superiores a 2.200 kWh/m²/ano, Tete posiciona-se como um polo de excelência para parques solares fotovoltaicos, sistemas térmicos industriais e energias renováveis na África Austral.',
    descriptionEn: 'The high solar irradiation and warm climate characterizing Tete province. With solar radiation exceeding 2,200 kWh/m²/year, Tete stands as a premier hub for utility-scale solar PV, industrial clean thermal solutions, and renewable energy across Southern Africa.',
    investmentOpportunities: [
      'Grandes centrais solares fotovoltaicas e sistemas de armazenamento em bateria (BESS)',
      'Sistemas solares térmicos industriais para processamento mineral e agroindústria',
      'Eletrificação rural sustentável com mini-redes solares inteligentes (mini-grids)'
    ],
    investmentOpportunitiesEn: [
      'Utility-scale solar PV farms and Battery Energy Storage Systems (BESS)',
      'Industrial solar thermal systems for mineral processing and agro-industry',
      'Sustainable rural electrification with smart off-grid solar mini-grids'
    ],
...
export * from './teteInvestmentData';

export const TRANSLATIONS = {
  pt: {
    navHome: 'Início',
    navAbout: 'Sobre CIIT',
    navAboutTete: 'Sobre Tete',
    navWhyInvest: 'Porquê Tete',
    navWhereToInvest: 'Onde Investir',
    navMinerals: 'Minérios por Distrito',
    navFisheries: 'Pesca & Aquacultura',
    navOtherPotentials: 'Outros Potenciais',
    navEnergy: 'Energia',
    navPortfolio: 'Portfólio de Projetos',
    navInvestorArea: 'Área do Investidor',
    navProfile: 'Perfil de Tete',
    nav6cs: 'Os 6C\'s de Tete',
    navSpeakers: 'Convidados de Honra',
    navAgenda: 'Programa',
    ...
    heroHeadline: 'Invista em Tete. Construa o futuro.',
    heroSubheadline: 'Descubra as oportunidades de investimento numa das regiões estratégicas de Moçambique, com vastos recursos naturais, potencial energético, agrícola, mineiro, turístico e logístico.',
    heroCtaExplore: 'Explorar oportunidades',
    heroCtaPortfolio: 'Ver portfólio de projetos',
    ...
    heroLocation: 'Horizonte Lodge, Tete, Moçambique',
    countdownDays: 'Dias',
    ...
    speakersTitle: 'Convidados de Honra',
    speakersSubtitle: 'Hierarquia Protocolar e Dignidades de Estado na CIIT 2026',
    ...
    investorAreaTitle: 'Encontre a sua oportunidade em Tete',
    investorAreaSubtitle: 'Explore os setores estratégicos, conheça os projetos disponíveis e descubra oportunidades para investir na Província de Tete.',
    investorAreaCta: 'Quero investir em Tete',
    investorFormSend: 'Enviar manifestação de interesse',
  ...
  en: {
    navHome: 'Home',
    navAbout: 'About CIIT',
    navAboutTete: 'About Tete',
    navWhyInvest: 'Why Tete',
    navWhereToInvest: 'Where to Invest',
    navMinerals: 'Minerals by District',
    navFisheries: 'Fisheries & Aquaculture',
    navOtherPotentials: 'Other Potentials',
    navEnergy: 'Energy',
    navPortfolio: 'Projects Portfolio',
    navInvestorArea: 'Investor Area',
    navProfile: 'Tete Profile',
    nav6cs: 'Tete 6 C\'s',
    navSpeakers: 'Guests of Honor',
    navAgenda: 'Agenda',
    ...
    heroHeadline: 'Invest in Tete. Build the future.',
    heroSubheadline: 'Discover investment opportunities in one of Mozambique\'s most strategic regions, endowed with vast natural resources, energy, agricultural, mining, tourism, and logistics potential.',
    heroCtaExplore: 'Explore Opportunities',
    heroCtaPortfolio: 'View Projects Portfolio',
    ...
    heroLocation: 'Horizonte Lodge, Tete, Mozambique',
    countdownDays: 'Days',
    countdownHours: 'Hours',
    countdownMinutes: 'Min',
    countdownSeconds: 'Sec',
    registerBtn: 'Register For Conference',
    learnMore: 'Explore Tete Resources',
    ...
    speakersTitle: 'Guests of Honor',
    speakersSubtitle: 'State Protocol Hierarchy and Dignitaries at CIIT 2026',
    ...
    investorAreaTitle: 'Find your opportunity in Tete',
    investorAreaSubtitle: 'Explore strategic sectors, review available projects, and discover high-yield opportunities to invest in Tete Province.',
    investorAreaCta: 'I want to invest in Tete',
    investorFormSend: 'Submit Expression of Interest',
